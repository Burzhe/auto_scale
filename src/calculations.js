import { MATERIAL_DENSITY, MAX_SECTION_WIDTH, PARTITION_THRESHOLD } from './state.js';
...
export function getMaterialDensity(materialName) {
...
export function inferDensityFromSpec(spec) {
...
export function calculateWeight(parts, density = MATERIAL_DENSITY) {
  let totalKg = 0;
  parts.forEach((part) => {
...
export function calculatePrice(parts, materials) {
  let total = 0;
  parts.forEach((part) => {
...
export function calculateFurnitureCost(furniture) {
...
export function inferPartType(name) {
...
export function splitSections(totalWidth) {
...
export function inferSectionCount(spec) {
...
export function getBaseStructure(spec) {
...
export function getBasePriceFromSpec(spec) {
